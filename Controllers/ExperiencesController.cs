...
namespace Portofolio.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Company,Role,Duration")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Company,Role,Duration")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
