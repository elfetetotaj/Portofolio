...
namespace Portofolio.Controllers
{
    public class CertificatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Duration")] Certificate certificate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Duration")] Certificate certificate)
        {
